...
async function loadGsap() {
  const g = await __vitePreload(() => import("./EKdnnN.js"), true ? [] : void 0);
  return g.gsap;
}
...
const Desktop = lazy(async () => await __vitePreload(() => import("./cjmZyo.js"), true ? [] : void 0));
const Mobile = lazy(async () => await __vitePreload(() => import("./ClNk2X.js"), true ? [] : void 0));
function Main() {
